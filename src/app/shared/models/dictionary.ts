...
export class Dictionary {
    terms = [
        ...
        { id: 13, name: 'View LuxuryNFT', plural: 'View LuxuryNFTs', alias: 'view_nft', ref: 'Product', },
        { id: 14, name: 'Transfer LuxuryNFT', plural: 'Transfer LuxuryNFTs', alias: 'transfer_nft', ref: 'Product', },
